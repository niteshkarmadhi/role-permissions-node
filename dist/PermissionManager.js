...
module.exports = /*#__PURE__*/function (_BaseDBHandler) {
  function PermissionManager(_connection, _dBDialect) {
    var _this;
    _classCallCheck(this, PermissionManager);
    _this = _callSuper(this, PermissionManager, [_connection, _dBDialect]);
    _defineProperty(_this, "permissionController", null);
    _defineProperty(_this, "groupController", null);
    _defineProperty(_this, "connection", null);
    _defineProperty(_this, "dBDialect", null);
    _this.connection = _connection;
    _this.dBDialect = _dBDialect;
    return _this;
  }
  _inherits(PermissionManager, _BaseDBHandler);
  return _createClass(PermissionManager, [{
    key: "permissions",
